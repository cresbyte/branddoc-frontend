    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your business information and brand assets.</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>This information will appear on your documents and client portal.</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Customize the look and feel of your client-facing pages.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">Your primary brand color for UI elements.</p>
                    </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="aspect-square bg-muted rounded-xl flex items-center justify-center border-2 border-dashed">
                <div className="text-center flex flex-col items-center p-6 text-muted-foreground">
                    <Upload className="h-10 w-10 mb-2 opacity-50" />
                    <span className="text-sm">Click to replace logo</span>
                </div>
              </div>
              <p className="text-xs text-muted-foreground text-center">Recommended: Square SVG or PNG with transparent background.</p>
            </CardContent>
          </Card>
        </div>
      </div>
