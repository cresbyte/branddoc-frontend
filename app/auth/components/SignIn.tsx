...
export function SignIn({ onSignUp, onForgot, onSuccess }: SignInProps) {
  ...
  return (
    <>
      <h1 style={{ fontSize: 24, fontWeight: 700, color: "#111827", marginBottom: 32 }}>Welcome back</h1>
        ...
        <form onSubmit={handleSubmit} style={{ textAlign: "left" }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 14, fontWeight: 600, cursor: password ? "pointer" : "default"
            }}
          >
      ...
      {step === 1 && (
        <p style={{ marginTop: 24, fontSize: 13.5, color: "#6B7280" }}>
            Don't have an account? <span onClick={onSignUp} style={{ color: "#111827", fontWeight: 600, cursor: "pointer" }}>Sign up</span>
        </p>
      )}
    </>
  );
